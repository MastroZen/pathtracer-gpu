			...
			fn compute(
				...
				for ( var bounce = 0u; bounce < maxBounces; bounce ++ ) {
					...
					if ( didHit ) {
						...
						// emission. The clamp depth is the one of Cycles, explained in LogicKernel: what a ray
						// finds is clamped at the segment index, the direct light below at one more
